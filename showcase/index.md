...
### 💰 Budgie the Budgeteer
**Modern Budget Tracking Application** — A comprehensive financial management tool that helps users track expenses, monitor budgets, and gain insights into their spending patterns.

**Technical Focus:** Full-stack web development, database design, user authentication, data visualization, financial analytics

**Key Contributions:**
- Designed and implemented intuitive expense categorization system
- Developed real-time budget monitoring with automated alerts
- Created insightful financial analytics dashboard for spending analysis
- Built secure user authentication and data management system

**Technologies:** Python, Django, PostgreSQL, JavaScript

[View Code on GitHub](https://github.com/YK12321/Budgeteer){:target="_blank"}

---

### 📦 Invelog
**Inventory Management System** — A streamlined stock tracking and organization system designed to help businesses manage inventory efficiently with real-time updates and reporting.

**Technical Focus:** Web application development, database management, real-time data processing, automated notifications

**Key Contributions:**
- Implemented real-time inventory tracking and updates
- Developed automated alert system for low stock levels
- Created detailed reporting capabilities for inventory analysis
- Built responsive user interface for easy stock management

**Technologies:** Python, Flask, SQLite, Bootstrap

[View Code on GitHub](https://github.com/YK12321/Invelog){:target="_blank"}
...
- **Software Development:** Full-stack web applications using Python frameworks (Django, Flask)
...
- **Engineering Tools:** ANSYS, MATLAB, STK, CAD modeling, Python
- **Database Design:** PostgreSQL, SQLite, data modeling and management
